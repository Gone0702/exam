...
pluralCaseList.push( {plural: "creates/exams", pascal: "CreateExam"} )

pluralCaseList.push( {plural: "requests/examReqs", pascal: "RequestExamReq"} )

pluralCaseList.push( {plural: "answers/userAnswereds", pascal: "AnswerUserAnswered"} )

pluralCaseList.push( {plural: "results/examResults", pascal: "ResultExamResult"} )
